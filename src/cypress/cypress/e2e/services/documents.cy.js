const endpoints = [
    {
        url: '/api/documents/eAFLT823KijKL8vMS07VLy5JLEm18s8rSSzKzLfOyczNLElNAQDp5A1l',
        method: 'GET',
        body: {},
        qs: {
            length: 10,
    ...
    {
        url: '/api/documents/eAFLT823KijKL8vMS07VLy5JLEm18s8rSSzKzLfOyczNLElNAQDp5A1l/query',
        method: 'GET',
        body: {},
        qs: {},
        headers: {},
    ...
    {
        url: '/api/documents/eAFLT823KijKL8vMS07VLy5JLEm18s8rSSzKzLfOyczNLElNAQDp5A1l/download',
        method: 'GET',
        body: {},
        qs: {
            format: 'tsv'
...
// Test Endpoint
describe('Test documents endpoint', () => {
...
endpoints.forEach((endpoint, index) => {
    benchmark(`Benchmark Test for documents`, options, () => {
