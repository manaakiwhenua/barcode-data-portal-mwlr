const endpoints = [
    {
        ...
        isDownload: false,
        expectedkeys: ["successful_terms"]
    }
];
const path = require('path');

// Test Endpoint
describe('Test query_preprocessor endpoint', () => {
...
endpoints.forEach((endpoint, index) => {
    benchmark(`Benchmark Test for query_preprocessor`, options, () => {
