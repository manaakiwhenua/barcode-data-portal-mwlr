const endpoints = [
    {
        url: '/api/taxonomy/eAFLT823KijKL8vMS07VLy5JLEm18s8rSSzKzLfOyczNLElNAQDp5A1l',
        method: 'GET',
        body: {},
        qs: {},
        headers: {},
        ...
        isDownload: false,
        expectedkeys: ["taxonomy"]
    },
    {
        url: '/api/taxonomy/eAFLT823KijKL8vMS07VLy5JLEm18s8rSSzKzLfOyczNLElNAQDp5A1l/map',
        method: 'GET',
        body: {},
        qs: {
            node_threshold: 1000
        ...
        failOnStatusCode: true,
        isDownload: false,
        expectedkeys: ["taxonomy_lineage","taxonomy"]
    }
];
const path = require('path');

// Test Endpoint
describe('Test taxonomy endpoint', () => {
...
endpoints.forEach((endpoint, index) => {
    benchmark(`Benchmark Test for taxonomy`, options, () => {
