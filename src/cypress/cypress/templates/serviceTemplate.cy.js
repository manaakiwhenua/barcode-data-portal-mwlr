// Replace "template" with your endpoint
const endpoints = [
    {
        url: '/api/query', // Enter the endpoint url here
        ...
        expectedStatus: 200, // Expected to get 200-OK from endpoint
        failOnStatusCode: true, // Fail on test if response code is not 200-OK
        isDownload: false, // Change to True if it is suppose to download a file
        expectedkeys: ["query_id"], // Cypress make sure that this key is exist in response
        // expectedKeyValues: {}, // Cypress make sure that this key is exist in response and the value is equal to expected value
        // resultArrayMinLen: 100 // Cypress make sure that the result list meet the minimum length
    }
];
const path = require('path');

// Test Endpoint
describe('Test template endpoint', () => {
